...
namespace Tests
{
	...
	public partial class TestDBContextDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteEvents(Events instance);
		...
		public TestDBContextDataContext() : 
				base(global::Tests.Properties.Settings.Default.BookstoreDB_TESTConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Books : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Suppliers> _Suppliers1;
    ...
    partial void OnidChanged();
		...
		public Books()
		{
			...
			this._Suppliers1 = default(EntityRef<Suppliers>);
			OnCreated();
		}
		...
		public System.Nullable<int> supplierID
		{
			...
			set
			{
				...
				{
					if ((this._Suppliers.HasLoadedOrAssignedValue || this._Suppliers1.HasLoadedOrAssignedValue))
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Suppliers_Books1", Storage="_Suppliers1", ThisKey="supplierID", OtherKey="id", IsForeignKey=true)]
		public Suppliers Suppliers1
		{
			get
			{
				return this._Suppliers1.Entity;
			}
			set
			{
				Suppliers previousValue = this._Suppliers1.Entity;
				if (((previousValue != value) 
							|| (this._Suppliers1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Suppliers1.Entity = null;
						previousValue.Books1.Remove(this);
					}
					this._Suppliers1.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("Suppliers1");
				}
			}
		}
	...
	public partial class Suppliers : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Books> _Books1;
    ...
    partial void OnidChanged();
		...
		public Suppliers()
		{
			...
			this._Books1 = new EntitySet<Books>(new Action<Books>(this.attach_Books1), new Action<Books>(this.detach_Books1));
			this._Events = new EntitySet<Events>(new Action<Events>(this.attach_Events), new Action<Events>(this.detach_Events));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Suppliers_Books1", Storage="_Books1", ThisKey="id", OtherKey="supplierID")]
		public EntitySet<Books> Books1
		{
			get
			{
				return this._Books1;
		...
		private void attach_Books1(Books entity)
		{
			this.SendPropertyChanging();
			entity.Suppliers1 = this;
		}
		
		private void detach_Books1(Books entity)
		{
			this.SendPropertyChanging();
			entity.Suppliers1 = null;
		}
